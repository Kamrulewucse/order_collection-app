...
<link rel="stylesheet"
      href="<?php echo e(asset('themes/backend/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')); ?>">
...
<style>
    ...
    a.nav-link.active.custom-third-menu-bg .nav-icon.fas.fa-circle {
        color: #007bff;
    }
    li.nav-item.menu-open .nav.nav-treeview.custom-third-layer a.nav-link.active i {
        color: #007bff;
    }

</style>
<?php /**PATH D:\wamp64\www\order-collection\resources\views/layouts/partial/__styles.blade.php ENDPATH**/ ?>