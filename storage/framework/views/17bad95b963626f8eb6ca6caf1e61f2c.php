...
<?php $__env->startSection('content'); ?>
    ...
    <!-- form start -->
    <form enctype="multipart/form-data" action="<?php echo e(route('distribution.store',['type'=>request('type')])); ?>" class="form-horizontal" method="post">
        <?php echo csrf_field(); ?>
        <div class="row">
        <!-- left column -->
        <div class="col-md-9">
                            ...
                            <div class="form-group <?php echo e($errors->has('company') ? 'has-error' :''); ?>">
                                ...
                                <select class="form-control select2" id="company" name="company">
                                    ...
                                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(request('company') == $company->id ? 'selected' : ''); ?> value="<?php echo e($company->id); ?>"><?php echo e($company->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                           ...
                           <div class="form-group">
                               ...
                               <select class="form-control select2" id="select_product" name="select_product">
                                   ...
                                   <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option <?php echo e(old('product') == $product->id ? 'selected' : ''); ?> value="<?php echo e($product->id); ?>">Brand: <?php echo e($product->brand->name ?? ''); ?> - <?php echo e($product->name); ?> - Code:<?php echo e($product->code); ?> - <?php echo e($product->unit->name ?? ''); ?></option>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                               </select>
                           </div>
                       </div>
                ...
                <!-- /.card-header -->
                                ...
                                <table class="table table-bordered">
                                   <thead>
                                    ...
                                    <tbody id="product-container">
                                        <?php if(old('product_id') != null && sizeof(old('product_id')) > 0): ?>
                                            <?php $__currentLoopData = old('product_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="product-item">
                                                    <td class="text-center">
                                                        <span class="product_sl"><?php echo e(++$key); ?></span>
                                                    </td>
                                                    <td class="text-left <?php echo e($errors->has('product_id.'.$loop->index) ? 'bg-gradient-danger' :''); ?>">
                                                        <span class="product_name"><?php echo e(old('product_name_val.'.$loop->index)); ?></span>
                                                        <input type="hidden" name="product_name_val[]" value="<?php echo e(old('product_name_val.'.$loop->index)); ?>" class="product_name_val">
                                                        <input type="hidden" name="product_id[]" value="<?php echo e(old('product_id.'.$loop->index)); ?>" class="product_id">
                                                    </td>
                                                    <?php if(request('type') == 3): ?>
                                                    <td class="text-right">
                                                        <div class="form-group mb-0  <?php echo e($errors->has('damage_return_product_qty.'.$loop->index) ? 'has-error' :''); ?>">
                                                            <input type="number" step="any" value="<?php echo e(old('damage_return_product_qty.'.$loop->index)); ?>" class="form-control text-right damage_return_product_qty" name="damage_return_product_qty[]">
                                                        </div>
                                                    </td>
                                                    <?php endif; ?>
                                                    <td class="text-right">
                                                        <div class="form-group mb-0  <?php echo e($errors->has('product_qty.'.$loop->index) ? 'has-error' :''); ?>">
                                                            <input type="number" step="any" value="<?php echo e(old('product_qty.'.$loop->index)); ?>" class="form-control text-right product_qty" name="product_qty[]">
                                                        </div>
                                                    </td>
                                                    <td class="text-right">
                                                        <div class="form-group mb-0  <?php echo e($errors->has('product_unit_price.'.$loop->index) ? 'has-error' :''); ?>">
                                                            <input type="number" step="any" value="<?php echo e(old('product_unit_price.'.$loop->index)); ?>" class="form-control text-right product_unit_price" name="product_unit_price[]">
                                                        </div>
                                                    </td>
                                    ...
                                    <tfoot>
                                        <tr style="<?php echo e((old('product_id') != null && sizeof(old('product_id'))) > 0 ? 'display: revert' : 'display: none'); ?>" id="footer_area">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('distribution.index')); ?>" class="btn btn-danger bg-gradient-danger btn-sm float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
            </div>
            <!-- /.card -->
        ...
        <div class="col-md-3">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group <?php echo e($errors->has('sr') ? 'has-error' :''); ?>">
                                <label for="dsr">DSR <span
                                        class="text-danger">*</span></label>
                                <select class="form-control select2" id="dsr" name="dsr">
                                    <option value="">Search Name of DSR</option>
                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(old('sr') == $supplier->id ? 'selected' : ''); ?> value="<?php echo e($supplier->id); ?>"><?php echo e($supplier->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['sr'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?php echo e($errors->has('date') ? 'has-error' :''); ?>">
                                <label for="date">Date <span
                                        class="text-danger">*</span></label>
                                <input type="text" autocomplete="off" value="<?php echo e(old('date',date('d-m-Y'))); ?>" name="date" id="date" class="form-control date-picker" placeholder="Enter date">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group <?php echo e($errors->has('notes') ? 'has-error' :''); ?>">
                                ...
                                <input type="text" value="<?php echo e(old('notes')); ?>" name="notes" id="notes" class="form-control" placeholder="Enter Notes">
    ...
    <script>
        $(function (){
            ...
            $('body').on('change', '#select_product', function (e) {
                ...
                let distribution_type = '<?php echo e(request('type')); ?>';
                $('#stock_quantity').html(' ');
                $('#add_unit_price').val(' ');
                if (product_id != '' && distribution_type == 1){
                    $.ajax({
                        method: "GET",
                        url: "<?php echo e(route('get_stock_info')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\order-collection\resources\views/distribution_order/create.blade.php ENDPATH**/ ?>