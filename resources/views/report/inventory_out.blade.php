@extends('layouts.app')
@section('title','Inventory Out Report')
@section('style')
    <style>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form action="{{ route('report.inventory_out') }}">
                        <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive-md" id="printArea">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <h3 class="text-center" style="font-size: 25px"><u><b>Inventory Out Report</b></u></h3>
                            ...
                            @endphp
                                @foreach($logs as $log)
                                    <tr>
                                        ...
                                        <td>{{ $log->product->supplier->name ?? '' }}</td>
            ...
            $('#btn-export').click(function(){
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        a.href = url;
                        a.download = 'inventory_out_report.xlsx';
