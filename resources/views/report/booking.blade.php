    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form action="{{ route('report.booking') }}">
                        <div class="row">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="table-responsive" id="printArea">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h3 class="text-center" style="font-size: 25px"><u><b>Reservation Report</b></u></h3>
                                ...
                                <tbody>
                                    @foreach($rooms as $room)
                                        <tr>
                                            ...
                                            @foreach($datesInRange as $dateInRange)
                                                @php
                                                    $bookingDetail = statusBookingRoom($room->id,$dateInRange);
                                                @endphp
                                             <td style="{{ $bookingDetail ? 'background:#ffc107!important;color:#000!important' : '' }}" class="text-center">
                                                @if($bookingDetail)
...
@section('script')
    <script>
        ...
        function getprint(print) {
            document.title = "{{ request('start_date') }}_to_{{ request('end_date') }}_reservation_report";
            $(".extra-remove").remove();
