                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{ $voucherType == 2 ? 'Head of Expense' : 'Head of Income' }}</th>
                                <th class="text-center">Amount</th>
                                <th class="text-center">{{ $voucherType == 2 ? 'Payment' : 'Receipt' }} Mode</th>
        ...
        $(function () {
            ...
            let table = $('#table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'account_heads', name: 'account_heads',orderable:false,searchable:false},
                    {data: 'amounts', name: 'amounts',orderable:false,searchable:false,className:'text-right'},
                    {data: 'payment_account_head_name', name: 'paymentAccountHead.name'},
