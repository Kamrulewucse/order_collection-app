                ...
                <form enctype="multipart/form-data" action="{{ route('sr.update',['sr'=>$sr->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('opening_balance') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('opening_balance',$sr->opening_balance) }}" name="opening_balance" class="form-control" id="opening_balance" placeholder="Enter Opening Balance">
