                ...
                <form enctype="multipart/form-data" action="{{ route('client.update',['client'=>$client->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('sr') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <select name="sr" id="sr" class="form-control select2">
                                    ...
                                    @foreach($srs as $sr)
                                        <option {{ old('sr',$client->sr_id) == $sr->id ? 'selected' : '' }} value="{{ $sr->id }}" data-district_id="{{ $sr->district_id }}">{{ $sr->name }}</option>
                                    @endforeach
                                </select>
                                @error('sr')
                        ...
                        <div class="form-group row {{ $errors->has('client_type') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <select name="client_type" id="client_type" class="form-control select2">
                                    ...
                                    <option value="Credit" {{ old('client_type',$client->client_type) == 'Credit'?'selected':'' }}>Credit Client</option>
                                    <option value="Debit" {{ old('client_type',$client->client_type) == 'Debit'?'selected':'' }}>Debit Client</option>
                                </select>
                                @error('client_type')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row {{ $errors->has('debit_balance') ? 'has-error' :'' }}" id="debit_balance_area">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('debit_balance',$client->debit_balance) }}" name="debit_balance" class="form-control" id="debit_balance" placeholder="Enter Debit Balance">
                                @error('debit_balance')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('latitude') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="any" value="{{ old('latitude',$client->latitude) }}" name="latitude" class="form-control" id="latitude" placeholder="Enter latitude">
                                @error('latitude')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('longitude') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="any" value="{{ old('longitude',$client->longitude) }}" name="longitude" class="form-control" id="longitude" placeholder="Enter longitude">
                                @error('longitude')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
