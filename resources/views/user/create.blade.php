            ...
            <div class="card card-default">
                ...
                <form enctype="multipart/form-data" action="{{ route('user.store') }}" class="form-horizontal" method="post">
                                ...
                                <tr>
                                    <td style="font-size: 20px"  class="text-left">
                                        <div class="icheck-success">
                                            <input type="checkbox" id="for_label_{{ $permission->id }}" class="parent-checkbox" name="permission[]"
                                        ...
                                        <ul>
                                            @foreach($permission->children as $childrenItem)
                                                <li style="font-size: 19px" >
                                                    ...
                                                    <div class="icheck-success">
                                                        <input type="checkbox" id="for_label_{{ $childrenItem->id }}" class="child-checkbox" name="permission[]"
                                                    ...
                                                    <ul>
                                                        @foreach($childrenItem->children as $childrenItem2)
                                                            <li style="font-size: 18px" >
                                                                <div class="icheck-success">
                                                                    <input type="checkbox" id="for_label_{{ $childrenItem2->id }}" class="grandchild-checkbox" name="permission[]"
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('user.index') }}" class="btn btn-danger bg-gradient-danger float-right">Cancel</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
