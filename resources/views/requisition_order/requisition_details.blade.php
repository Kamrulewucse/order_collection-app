                        ...
                        <div class="row pt-3 pb-3">
                            ...
                            <div class="col-4">
                                <h5 class="text-center m-0">DATE:
                                    {{ \Carbon\Carbon::parse($requisitionOrder->date)->format('d-m-Y') }}</h5>
                            </div>
                        </div>
                        <table id="table" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="14%">Requisition Qty</th>
                            ...
                            <tbody>
                                ...
                                @endphp
                                @foreach ($requisitionOrder->requisitionOrderItems as $item)
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right" id="total-amount"> {{ number_format($requisitionOrder->total, 2) }}
                                    </th>
                                </tr>
                                <tr>
                                    <th class="text-right" colspan="4">Advance</th>
                                    <th class="text-right"> {{ number_format($requisitionOrder->advance, 2) }}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
...
@section('script')
    <script>
        ...
        function getprintChallan(print) {
            document.title = "{{ $requisitionOrder->order_no }}_{{ $pageTitle }}_details";
            $(".extra-remove").remove();
