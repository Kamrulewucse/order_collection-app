...
@section('content')
    ...
    <!-- form start -->
    <form enctype="multipart/form-data" action="{{ route('requisition-order.store') }}" class="form-horizontal" method="post">
        @csrf
        <div class="row">
        <!-- left column -->
        <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->has('advance') ? 'has-error' :'' }}">
                                ...
                                <input type="text" value="{{ old('advance',0) }}" name="advance" id="advance" class="form-control" placeholder="Enter Advance">
                                @error('advance')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
