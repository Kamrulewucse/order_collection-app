...
@section('content')
    ...
    <!-- form start -->
    <form enctype="multipart/form-data" action="{{ route('purchase.store') }}" class="form-horizontal" method="post">
        @csrf
        <div class="row">
        <!-- left column -->
        <div class="col-md-9">
            ...
            <div class="card card-default">
                                ...
                                <div class="form-group {{ $errors->has('company') ? 'has-error' :'' }}">
                                    ...
                                    <select class="form-control select2" id="company" name="company">
                                        ...
                                        @foreach($clients as $supplier)
                                            <option {{ request('company') == $supplier->id ? 'selected' : ''  }} value="{{ $supplier->id }}">{{ $supplier->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('company')
                ...
                <div class="card-header">
                    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="add_selling_price">Sale Unit Price <span class="text-danger">*</span></label>
                                    <input type="number" step="any" class="form-control" id="add_selling_price" placeholder="Sale Unit Price">
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
