        ...
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <a href="{{ route('supplier.create') }}" class="btn btn-primary bg-gradient-primary btn-sm">Create Company <i class="fa fa-plus"></i></a>
                    @endif
                </div>
                <!-- /.card-header -->
                <div class="card-body">
            ...
            $('body').on('click', '.btn-delete', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            method: "DELETE",
                            url: "{{ route('supplier.destroy', ['supplier' => 'REPLACE_WITH_ID_HERE']) }}".replace('REPLACE_WITH_ID_HERE', id),
                            data: { id: id }
